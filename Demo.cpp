...
int main() {
    ...
    treeK->add_root(1);
    treeK->add_sub_node(treeK->get_root(), 2);
    treeK->add_sub_node(treeK->get_root(), 3);
    treeK->add_sub_node(treeK->get_root(), 4);
    treeK->add_sub_node(treeK->get_root()->children[0], 5);
    treeK->add_sub_node(treeK->get_root()->children[1], 6);
    treeK->add_sub_node(treeK->get_root()->children[1], 7);
    treeK->add_sub_node(treeK->get_root()->children[2], 8);
    treeK->add_sub_node(treeK->get_root()->children[2], 9);
    treeK->add_sub_node(treeK->get_root()->children[2], 10);
